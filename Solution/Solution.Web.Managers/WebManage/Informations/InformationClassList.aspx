...
<body>
    ...
    <f:panel id="Panel1" runat="server" title="信息分类列表" enableframe="false" bodypadding="10px"
        enablecollapse="True">
        <toolbars>
        ...
        <items>
             <f:SimpleForm ID="SimpleForm1" BodyPadding="5px" runat="server" EnableFrame="false" EnableCollapse="true"
                ...
                <Items>
                    <f:DropDownList Label="信息分类选择" runat="server" ID="ddlParentId" Width="250px"></f:DropDownList>
                </Items>
            </f:SimpleForm>
            <f:Grid ID="Grid1" Title="信息分类列表" EnableFrame="false" EnableCollapse="true" AllowSorting="true"
            ...
            OnPageIndexChange="Grid1_PageIndexChange" OnPreRowDataBound="Grid1_PreRowDataBound" OnRowCommand="Grid1_RowCommand">
                <Columns>
                    <f:RowNumberField />
                    <f:BoundField Width="100px" DataField="Name" DataFormatString="{0}" DataSimulateTreeLevelField="Depth" HeaderText="名称" />
                    ...
                    <f:CheckBoxField RenderAsStaticField="true" DataField="IsSys" HeaderText="是否系统分类" Width="100px" />
                    <f:LinkButtonField HeaderText="是否显示" Icon="BulletCross" TextAlign="Center" ToolTip="点击修改是否显示" ColumnID="IsShow" CommandName="IsShow" />
                    <f:LinkButtonField HeaderText="是否为单页" Icon="BulletCross" TextAlign="Center" ToolTip="点击修改是否单页" ColumnID="IsPage" CommandName="IsPage" />
