...
<body>
    ...
    <f:panel id="Panel1" runat="server" title="上传配置列表" enableframe="false" bodypadding="10px"
        enablecollapse="True">
        <toolbars>
        ...
        <items>
            <f:Grid ID="Grid1" Title="上传配置列表" EnableFrame="False" EnableCollapse="true" AllowSorting="true" IsDatabasePaging="True" Width="880px"
            ...
            OnPageIndexChange="Grid1_PageIndexChange" OnPreRowDataBound="Grid1_PreRowDataBound" OnRowCommand="Grid1_RowCommand" OnSort="Grid1_Sort">
                <Columns>
                    ...
                    <f:BoundField Width="120px" DataField="Name" SortField="Name" HeaderText="名称" />
                    <f:BoundField Width="100px" DataField="UploadType_Name" SortField="UploadType_Id" HeaderText="上传类型" /> 
                    <f:BoundField Width="100px" DataField="PicSize" HeaderText="图片上传限制" /> 
                    <f:BoundField Width="100px" DataField="FileSize" HeaderText="附件上传限制" /> 
                    <f:BoundField Width="200px" DataField="SaveDir" HeaderText="保存路径" /> 
                    <f:CheckBoxField Width="80px" RenderAsStaticField="true" DataField="IsPost" HeaderText="是否启用" />
    ...
    <f:window id="Window1" width="700px" height="500px" icon="TagBlue" title="编辑" hidden="True"
